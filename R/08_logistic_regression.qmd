...
body_measurements <- body_measurements |>
  mutate(PCOS_diagnosis = factor(PCOS_diagnosis, levels = c("No", "Yes"), labels = c(0, 1)))|>
...
plot_follicle_R <- body_measurements |>
  ...
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "pink", linewidth = 0.5) +  
  geom_vline(xintercept = 8.4, linetype = "dashed", color = "pink", linewidth = 0.5) + 
  geom_point(x = 8.4, y = 0.5, color = "pink", size = 4) + 
...
plot_follicle_L <- body_measurements |>
  ...
  geom_smooth(method = "glm",
              method.args = list(family = "binomial"))+
  geom_hline(yintercept = 0.5, linetype = "dashed", color = "pink", linewidth = 0.5) +  
  geom_vline(xintercept = 9.0, linetype = "dashed", color = "pink", linewidth = 0.5) + 
  geom_point(x = 9.0, y = 0.5, color = "pink", size = 4) + 
  labs(title = "Logistic Regression Model",
        x = "Follicle number (L)",
        y = "PCOS diagnosis (Yes/no)") +
   theme_minimal()
