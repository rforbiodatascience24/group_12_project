...
explained_variance_blood <- pca_fit |>
  ...
  geom_line(aes(y = cumulative / transformation_co), color = "purple1") +
  geom_point(aes(y = cumulative / transformation_co), color = "purple4") +
...
PCA3 <- ggplot(pca_augmented_pcos, 
       aes(.fittedPC8, .fittedPC9, color = cycle_or_pregnancy_stage)) +
  geom_point(size = 1.5, 
             alpha = 0.5) +
