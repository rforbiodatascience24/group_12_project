...
For easy summary of the data, the following can also be performed.
...
summary_table <- PCOS |>
  table1(x = formula(~ age + weight + height + pulse + breaths_pr_min + cycle_RI + period_length + period_length + pregnant + abortions + weight_gain + hair_growth + darker_skin + hair_loss | PCOS_diagnosis)) 
