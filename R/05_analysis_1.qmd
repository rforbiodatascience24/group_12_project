...
PCOS_BMI_correlation_box <- body_measurements |> 
  ...
  labs(x = "PCOS diagnosis", 
       y = "BMI",
       title = "Boxplot over correlation between BMI and PCOS diagnosis",
       fill = "PCOS diagnosis")+
...
PCOS_endometrium_correlation_box <- body_measurements |> 
  ...
  labs(x = "PCOS diagnosis", 
       ...
       title = "Boxplot over correlation between endometrium size and PCOS diagnosis",
       fill = "PCOS diagnosis")+
  scale_fill_brewer(palette="Set3")+
  theme_light()

print(PCOS_endometrium_correlation_box)
