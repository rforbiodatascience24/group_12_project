...
|                                            |                                                          |
|---------------------------------------|---------------------------------|
| ![](images/07_blood_PCA.png){width="12cm"} | ![](images/07_explained_variance_blood.png){width="500"} |
...
|                                           |                                            |
|-------------------------------------------|--------------------------------------------|
| ![](images/07_body_PCA.png){width="13cm"} | ![](images/07_rotation_matrix_body-01.png) |
:::
