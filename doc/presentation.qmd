...
::: columns
::: {.column width="50%"}
![](images/05_follicle_L_box.png){style=".smaller"}
:::

::: {.column width="50%"}
![](images/05_follicle_R_box.png){style=".smaller"}
:::
:::
:::
...
|                                           |                                                       |
|-------------------------------|-----------------------------------------|
| ![](images/07_body_PCA.png){width="15cm"} | ![](images/07_rotation_matrix_body.png){width="12cm"} |
:::
...
|                                          |                                                 |
|---------------------------------|---------------------------------------|
| ![](images/06_box_AMH.png){width="14cm"} | ![](images/06_cor_blood_plot.png){width="12cm"} |
...
|                                            |                                                           |
|------------------------------|------------------------------------------|
| ![](images/07_blood_PCA.png){width="15cm"} | ![](images/07_explained_variance_blood.png){width="12cm"} |
